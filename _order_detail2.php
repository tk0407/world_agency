...
<body>
  ...
  <div style="margin-top: 30px; z-index: 1; background-image: url(assets/img/portfolio/infoback1.jpg); background-position:center center; background-repeat:no-repeat; background-attachment: fixed; background-size: cover;">
