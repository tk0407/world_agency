<?php
    ...
    // ユーザー情報取得
    $sql = 'SELECT * FROM users LEFT JOIN offers ON offers.user_id = users.id WHERE offers.order_id = ? ORDER BY updated DESC';
        ...
        <ul class="list-group" id="contact-list">
            <li class="list-group-item">
              <a href="">
                ...
                <div class="col-xs-2">
                <a href="agentdetail.php?agent_id=<?php echo $orders[$i]['id'] ?>">
