<?php
    ...
    if(!isset($_SESSION['register'])) {
      header('Location: order_detail3.php');
      exit();
    }
    ...
    if (!empty($_POST)) {
        ...
        $sql = 'INSERT INTO `orders` SET
          ...
          ';
          // 上記が雛形の書き方
        $file = array($title,$file,$order_price,$delivery_date,$delivery_format,$publication_period,$recruitment_numbers,$requirement_skills,$images,$detail,$request,$purpose,$attached_file);
      ...
      <div class="col-xs-8 col-xs-offset-2 thumbnail">
        ...
        <div class="row">
          ...
          <div class="col-xs-8">
            ...
            <!-- ③ -->
            <form method="POST" action="order_check3.php">
              <!-- ④ -->
              <a href="order_detail3.php?action=rewrite" class="btn btn-default">&laquo;&nbsp;戻る</a> |
              <!-- ⑤ -->
