<?php
    ...
    if (!empty($_POST)) {
        ...
        if (empty($errors)) {
          ...
          header('Location: _order_check3.php');
          exit();
        }
    }
?>
    ...
    <div class="row">
      ...
      <div class="col-xs-8 col-xs-offset-2 thumbnail">
        ...
        <form method="POST" action="_order_detail3.php" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="file">データ数</label>
            <input type="number" name="input_file" class="form-control" id="file" placeholder="30 jpg_files" value="<?php echo $file; ?>">
            <?php if(isset($errors['file']) && $errors['file'] == 'blank'){ ?>
              <p class="text-danger">依頼データの数を入力して下さい</p>
            <?php } ?>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="input_delivery_format" class="form-control" id="delivery_format" placeholder="jpg/png file" value="<?php echo $delivery_format; ?>">
